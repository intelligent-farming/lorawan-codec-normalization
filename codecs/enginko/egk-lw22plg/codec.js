...
//
// Normalized payload codec for Enginko / MCF88 EGK-LW22PLG (LoRaWAN Smart Plug
// energy meter: 230Vac / 16A load, active / reactive / apparent energy and
// power, RMS voltage and current, line frequency). Enginko is the MCF88 rebrand.
//
...
// decodeUplink/parseMetering path; we author the normalization here. The upstream
// reverseBytes/parseSigned* string-slicing helpers and the non-deterministic
// toLocaleString() date are not reused — the same little-endian arithmetic is
// performed on the byte array and the packed timestamp is emitted as an RFC3339
// (UTC) string.
//
