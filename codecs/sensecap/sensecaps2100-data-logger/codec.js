...
//
// Normalized payload codec for sensecap/sensecaps2100-data-logger (SenseCAP
// S2100 data logger paired with an 8-in-1 weather sensor).
//
// Wire-format decoder ported verbatim from the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/sensecap/sensecaps2100-data-logger.js,
 ...
 * Entry, decoder.js
 */
function sensecapDecode(input, port) {
  // data split
...
function decodeUplink(input){var result=decodeUplinkCore(input);if(result&&result.data){result.data.make="sensecap";result.data.model="sensecaps2100-data-logger";}return result;}
