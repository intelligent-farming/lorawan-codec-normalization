...
//
// Normalized payload codec for nke-watteco TH (Temperature & Humidity sensor).
//
...
// vendor/nke-watteco/th-sensor.js, attributed in NOTICE). Ported from that
...
// measurement and is surfaced as the camelCase extra `messageType`. This device
// reports no pressure (0x0403) or CO2 cluster; none is emitted.
//
...
// nke-watteco Atm'O codec instead: it emits the first present power source as
// the volts `battery` reading without crashing.
