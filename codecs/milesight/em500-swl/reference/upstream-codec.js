...
//
// Source: Milesight EM500-SWL payload decoder (Apache-2.0), file
// "em500-swl-decoder.js" from
// https://github.com/Milesight-IoT/SensorDecoders/tree/main/em-series/em500-swl
// Kept verbatim as the wire-format reference our normalized codec.js was
// authored from. The Milesight decoder (not the TheThingsNetwork snapshot,
// which reports a raw count) is the source of truth for the calibrated
// depth (cm); device.json ttn is null.
...
function milesightDeviceDecode(bytes) {
    ...
    for (var i = 0; i < bytes.length; ) {
        ...
        // DEPTH
            ...
            var depth_value = readUInt16LE(bytes.slice(i, i + 2));
            if (depth_value === 0xffff) {
                decoded.depth_error = readSensorStatus(1);
