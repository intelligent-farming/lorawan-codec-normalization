...
//
// Normalized payload codec for Mutelcor MTC-CO2-01 (Smart CO2 LoRa Sensor:
...
// decoder (TheThingsNetwork/lorawan-devices vendor/mutelcor/mutelcor-codec.js,
...
// the CO2/climate-relevant opcodes (Heartbeat, Alarm, Measurements,
// Thresholds, Switch, SCD30), so the long config/show/update opcodes are not
// modelled.
//
...
// Everything else the device may report is surfaced as a camelCase extra:
//   messageType, payloadVersion, buttons, alarmId, switchState, tvoc,
//   distance, digitalInputs.
