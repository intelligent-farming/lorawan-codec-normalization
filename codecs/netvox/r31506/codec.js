...
//
// Normalized payload codec for Netvox R31506 (R315 - Wireless Temperature /
// Humidity / Internal Vibration / PIR / Emergency Button / Tilt Sensor), data
// report on fPort 6.
//
...
// normalizeUplink.
//
// Frame layout (fPort 6): bytes[0]=version, bytes[1]=deviceType (0xD2 = R315),
// bytes[2]=reportType. Battery is volts (high bit of bytes[3] is the
...
// (air.lightIntensity, lux) plus threshold-alarm flags; report 0x12 carries
// temperature, humidity (0.01 %) and illuminance plus alarm flags. Device-info
// (bytes[2] == 0x00), the sensor-enable/state snapshot (bytes[2] == 0x11) and
