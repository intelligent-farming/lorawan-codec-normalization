...
//
// Normalized payload codec for Netvox R718MBA (Wireless Activity Detection /
...
// bytes[1] the device type (0x27 == 39 == R718MBA) and bytes[2] the
...
// vibration status: non-zero means vibration is currently detected. This
// vibration state maps to the `motion` category: action.motion.detected
// (boolean) and action.motion.count (the raw status value). Config responses
// (fPort 7) and the device-info frame carry no measurement and are reported as
// errors.
