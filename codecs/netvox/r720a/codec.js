...
//
// Normalized payload codec for Netvox R720A (Wireless Temperature and Humidity
...
// bytes[1] the device type (0x6E == 110 == R720A) and bytes[2] the report-type
...
// 0.01 C (16-bit big-endian, two's-complement) -> air.temperature, and
// bytes[6..7] are relative humidity in 0.01 % (16-bit big-endian) ->
// air.relativeHumidity. Config responses (fPort 7) carry no measurement.
