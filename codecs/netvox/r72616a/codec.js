...
//
// Normalized payload codec for Netvox R72616A (Wireless PM2.5 / Temperature /
...
// bytes[1] the device type (0x6A == 106 == R72616A) and bytes[2] the report-type
...
// and bytes[8..9] are PM2.5 mass concentration in ug/m3 (16-bit big-endian).
...
function decodeUplinkCore(input) {
  ...
  // Bytes 8-9: PM2.5 mass concentration in ug/m3 (16-bit big-endian). Not a
  // vocabulary key; surfaced as a camelCase extra.
