...
//
// Normalized payload codec for netvox/r718x (ultrasonic distance + inclination sensor).
//
// Netvox payload decoder ported verbatim from the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/netvox/r718x.js, attributed in
