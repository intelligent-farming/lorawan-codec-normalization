...
//
// Normalized payload codec for Netvox R311WA (Wireless Seat / Occupancy
// Sensor), data report on fPort 6.
//
// Original work for @intelligent-farming/lorawan-codec-normalization. Wire
// format understood with reference to the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/netvox/payload/r311wa.js, attributed
// in NOTICE). Author the normalization here; do NOT copy upstream
// normalizeUplink.
//
// fPort 6 carries device reports: bytes[1] is the device-type id (90 ==
// R311WA) and bytes[2] is the report-type discriminator. reportType 0x00 is a
...
//   byte 4: occupancy/PIR state (upstream Status_1). 0x00 == clear, non-zero
//           == occupied/motion detected -> action.motion.detected (boolean).
//   byte 5: secondary state flag (upstream Status_2). Not a vocabulary
//           measurement; surfaced verbatim as the camelCase extra `status2`
//           (boolean) for fidelity.
//
...
function decodeUplinkCore(input) {
  ...
  // Byte 5: secondary state flag (vendor-specific, not a vocabulary key).
