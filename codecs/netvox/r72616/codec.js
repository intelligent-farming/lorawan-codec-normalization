...
//
// Normalized payload codec for Netvox R72616 (Wireless Outdoor
// PM2.5 / Temperature / Humidity Sensor with Solar Panel), data report on
// fPort 6.
//
...
// bytes[1] the device type (0x36 == 54 == R72616) and bytes[2] the report-type
...
// and bytes[8..9] are the PM2.5 concentration in ug/m3 (16-bit big-endian).
// The vocabulary does not model particulate matter, so PM2.5 is surfaced as the
// camelCase extra `pm25` (see categories/air-quality.json). Config responses
...
function decodeUplinkCore(input) {
  ...
  // Bytes 8-9: PM2.5 concentration in ug/m3 (16-bit big-endian). The
  // vocabulary does not model particulate matter; surface as a camelCase extra.
