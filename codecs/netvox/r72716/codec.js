...
//
// Normalized payload codec for Netvox R72716 (RA0716Y - Wireless Outdoor PM2.5
...
// bytes[1] the device type (0x37 == 55 == R72716) and bytes[2] the report-type
...
// and bytes[8..9] are the PM2.5 concentration in ug/m3 (16-bit big-endian). The
// vocabulary does not model particulate matter, so PM2.5 is surfaced as the
// camelCase extra `pm2_5`. Config responses (fPort 7) carry no measurement.
...
function decodeUplinkCore(input) {
  ...
  // Bytes 8-9: PM2.5 concentration in ug/m3 (16-bit big-endian). The vocabulary
  // does not model particulate matter, so surface it as a camelCase extra.
