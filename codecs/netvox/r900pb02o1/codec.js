...
//
// Normalized payload codec for Netvox R900PB02O1, data report on fPort 22.
//
...
// uplink measurement; the "DryContactPointOut" fields exist only in fPort 23
// config-command echoes, which are not measurements. We therefore normalize the
// real wire format faithfully.
//
// fPort 22: bytes[0] frame version, bytes[1..2] 16-bit big-endian device type
// (0x010F == 271 == R900PB02O1), bytes[3] report-type discriminator. reportType
