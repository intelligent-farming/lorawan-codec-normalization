...
//
// Normalized payload codec for pallidus/mr1. STUB — not yet authored.
//
// Wire format to be understood with reference to the upstream Apache-2.0
// decoder (TheThingsNetwork/lorawan-devices vendor/pallidus/codec-mr1.js, attributed in NOTICE).
