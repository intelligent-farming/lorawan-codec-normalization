...
//
// Normalized payload codec for nexelec/sign. STUB — not yet authored.
//
// Wire format to be understood with reference to the upstream Apache-2.0
// decoder (TheThingsNetwork/lorawan-devices vendor/nexelec/sign-codec.js, attributed in NOTICE).
