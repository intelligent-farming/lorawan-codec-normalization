...
//
// Normalized payload codec for nexelec/guard (Nexelec smoke + indoor air-quality
...
// (TheThingsNetwork/lorawan-devices vendor/nexelec/guard.js, attributed in
...
function decodeUplink(input){var result=decodeUplinkCore(input);if(result&&result.data){result.data.make="nexelec";result.data.model="guard";}return result;}
