...
//
// Normalized payload codec for moirelabs/p1ap (Moire Labs P1AP digital
...
// the current ("last") reading to the vocabulary key pressure.absolute (kPa)
...
function decodeUplink(input) {
  ...
  var data = {
    pressure: { absolute: round(last, 4) },
    pressureAbsoluteMin: round(min, 4),
    pressureAbsoluteMax: round(max, 4),
    pressureAbsoluteAverage: round(avg, 4)
  };
