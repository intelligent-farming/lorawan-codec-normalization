...
//
// Normalized payload codec for makerfabs/positioning-water-leak (Makerfabs rope/cable water-leak
...
// (TheThingsNetwork/lorawan-devices vendor/makerfabs/positioning-water-leak.js, attributed in
...
function decodeUplink(input) {
  ...
  if (result && result.data) {
    ...
    result.data.model = "positioning-water-leak";
  }
  return result;
}
