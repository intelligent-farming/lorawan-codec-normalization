...
//
// Normalized payload codec for mcf88/mcf-lw12met (MCF88 LW12 electricity meter).
//
// Wire-format decoder ported verbatim from the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/mcf88/mcf-lw12met.js, attributed in
...
function decodeUplink(input){var result=decodeUplinkCore(input);if(result&&result.data){result.data.make="mcf88";result.data.model="mcf-lw12met";}return result;}
