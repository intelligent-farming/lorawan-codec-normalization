...
//
// Normalized payload codec for Dragino LWL01 (Water Leak / Door Sensor),
// real-time status uplink (fPort 10).
//
// Original work for @intelligent-farming/lorawan-codec-normalization. Wire
// format understood with reference to the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/dragino/lwl01.js, attributed in
// NOTICE). The LWL01 is a dual-purpose probe with a work-mode byte (MOD):
