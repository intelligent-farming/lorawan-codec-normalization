...
//
// Source: Dragino S31B-LB/LS family decoder, file "s31b v1.8decoder.js" from the
// Dragino end-node decoder set (https://github.com/dragino/dragino-end-node-decoder),
// product manual at https://wiki.dragino.com (S31B-LB Temperature & Humidity Sensor).
// The S31B-LB2 shares this payload format. Kept verbatim as the wire-format
// reference our normalized codec.js was authored from. This exact slug is not in
// TheThingsNetwork/lorawan-devices, so device.json ttn is null.
