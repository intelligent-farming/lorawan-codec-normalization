...
//
// Normalized payload codec for rejeee/sl110us (Rejeee SL110US Temperature & Humidity Sensor). Original work;
...
function decodeUplink(input) {
  ...
  if (result && result.data) { result.data.make = "rejeee"; result.data.model = "sl110us"; }
  return result;
}
