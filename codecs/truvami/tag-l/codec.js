...
//
// Normalized payload codec for truvami/tag-l (Truvami "tag L" asset tracker).
//
// Ported from the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/truvami/tag-s-l.js, attributed in
// NOTICE). The wire format below was understood with reference to that decoder;
// the normalization is authored here and does NOT copy upstream normalizeUplink.
//
