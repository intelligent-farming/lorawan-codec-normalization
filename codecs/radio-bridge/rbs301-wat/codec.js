...
//
// Normalized payload codec for RadioBridge RBS301-WAT (Indoor Water Detect
// Sensor, probe: water present / not-present detection).
//
...
//
// This is a water-leak sensor: the WATER event (0x08) maps to water.leak. The
// RadioBridge water probe reports detection as an event STATE, not a field named
// "leak": upstream emits Water.Event "Water Present" (byte[2]==0) or "Water Not
