...
//
// Normalized payload codec for radio-bridge/rbs306-temp-tc (RBS306-TEMP-TC Thermocouple Temperature Sensor).
//
...
// NOTICE), renamed radioBridgeDecode. decodeUplinkCore maps the event to the
// vocabulary: thermocouple temperature -> temperature (C); fault flags as extras. Reset/supervisory/undefined frames -> error.
...
function decodeUplinkCore(input) {
  ...
  var data = {};
  if (d.Thermocouple && typeof d.Thermocouple.Temperature === "number") { data.temperature = d.Thermocouple.Temperature; if (d.Thermocouple.Fault) { data.thermocoupleFault = d.Thermocouple.Fault; } if (d.Thermocouple.Event !== undefined) { data.event = d.Thermocouple.Event; } }
...
function decodeUplink(input) {
  ...
  if (result && result.data) { result.data.make = "radio-bridge"; result.data.model = "rbs306-temp-tc"; }
  return result;
}
