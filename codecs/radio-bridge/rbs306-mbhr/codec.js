...
//
// Normalized payload codec for radio-bridge/rbs306-mbhr (MultiTech / Radio Bridge
// RBS306-MBHR Maxbotix ultrasonic distance sensor).
//
...
// NOTICE), renamed radioBridgeDecode. The Maxbotix HR sensor reports the
// ultrasonic event: distance (mm) -> tank.distance (m, /1000). Reset/undefined
// frames -> error.
...
function decodeUplink(input) {
  ...
  if (result && result.data) { result.data.make = "radio-bridge"; result.data.model = "rbs306-mbhr"; }
  return result;
}
