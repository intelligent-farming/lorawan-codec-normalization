...
//
// Normalized payload codec for tektelic/t00073xx-tundra-sensor (environmental temperature/humidity sensor).
//
// Tektelic TLV decoder ported verbatim from the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/tektelic/t00073xx-tundra-sensor.js, attributed in
...
function decodeUplink(input) {
  ...
  if (result && result.data) {
    ...
    result.data.model = "t00073xx-tundra-sensor";
  }
  return result;
}
