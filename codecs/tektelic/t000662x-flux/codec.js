...
//
// Normalized payload codec for tektelic/t000662x-flux (AC power outlet/switch with energy metering).
//
// Tektelic TLV decoder ported verbatim from the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/tektelic/t000662x-flux.js, attributed in
...
function decodeUplink(input) {
  ...
  if (result && result.data) {
    ...
    result.data.model = "t000662x-flux";
  }
  return result;
}
