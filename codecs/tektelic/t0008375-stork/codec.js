...
//
// Normalized payload codec for tektelic/t0008375-stork (temperature/humidity environmental sensor).
//
// Tektelic TLV decoder ported verbatim from the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/tektelic/t0008375-stork.js, attributed in
...
function decodeUplink(input) {
  ...
  if (result && result.data) {
    ...
    result.data.model = "t0008375-stork";
  }
  return result;
}
