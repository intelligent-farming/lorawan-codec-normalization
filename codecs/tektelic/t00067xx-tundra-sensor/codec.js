...
//
// Normalized payload codec for tektelic/t00067xx-tundra-sensor (environmental temperature/humidity sensor).
//
// Tektelic TLV decoder ported verbatim from the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/tektelic/t00067xx-tundra-sensor.js, attributed in
// NOTICE), renamed tektelicDecode. decodeUplinkCore maps ambient temperature/
// humidity -> air.temperature/air.relativeHumidity; MCU/onboard temperature and
// other channels -> camelCase extras; unparseable frames -> error.
...
function decodeUplink(input) {
  ...
  if (result && result.data) {
    ...
    result.data.model = "t00067xx-tundra-sensor";
  }
  return result;
}
