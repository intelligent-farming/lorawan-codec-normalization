...
//
// Normalized payload codec for tektelic/t000589x-ac-switch-gen1 (AC power outlet/switch with energy metering).
//
// Tektelic TLV decoder ported verbatim from the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/tektelic/t000589x-ac-switch-gen1.js, attributed in
...
function decodeUplink(input) {
  ...
  if (result && result.data) {
    ...
    result.data.model = "t000589x-ac-switch-gen1";
  }
  return result;
}
