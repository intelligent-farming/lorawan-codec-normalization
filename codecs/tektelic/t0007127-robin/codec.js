...
//
// Normalized payload codec for tektelic/t0007127-robin (Tektelic environmental sensor).
//
// Tektelic TLV decoder ported verbatim from the upstream Apache-2.0 decoder
// (TheThingsNetwork/lorawan-devices vendor/tektelic/t0007127-robin.js, attributed in
...
function decodeUplink(input){var result=decodeUplinkCore(input);if(result&&result.data){result.data.make="tektelic";result.data.model="t0007127-robin";}return result;}
