...
//
// Normalized payload codec for SEZO AL (sezo/sezoal) — air/ambient quality
// sensor (temperature, humidity, barometric pressure, illuminance, IAQ index,
// particulate matter, loudness, PIR presence).
//
...
// upstream `data` shape is NOT used as our output.
...
// table. divisor is a single number for scalar types.
function sensorType(t) {
  switch (t) {
    ...
    case 202: return { size: 1, name: 'PM1', signed: false, divisor: 1 };
    case 203: return { size: 1, name: 'PM2_5', signed: false, divisor: 1 };
    case 204: return { size: 1, name: 'PM4', signed: false, divisor: 1 };
    case 205: return { size: 1, name: 'PM10', signed: false, divisor: 1 };
...
function decodeUplinkCore(input) {
  ...
  if (dev.PM1 !== undefined) {
    air.pm1 = round(dev.PM1, 0);
  }
  if (dev.PM2_5 !== undefined) {
    air.pm2p5 = round(dev.PM2_5, 0);
  }
  if (dev.PM4 !== undefined) {
    air.pm4 = round(dev.PM4, 0);
  }
  if (dev.PM10 !== undefined) {
    air.pm10 = round(dev.PM10, 0);
  }
  ...
  if (air.temperature !== undefined || air.relativeHumidity !== undefined ||
      ...
      air.iaq !== undefined || air.pm1 !== undefined || air.pm2p5 !== undefined ||
      air.pm4 !== undefined || air.pm10 !== undefined || air.loudness !== undefined) {
    data.air = air;
  }
