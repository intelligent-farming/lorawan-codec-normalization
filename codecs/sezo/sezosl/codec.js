...
//
// Normalized payload codec for SEZO SL (sezo/sezosl) — air/ambient quality
// sensor (temperature, humidity, barometric pressure, illuminance, IAQ index,
// PIR presence). The SL variant omits the AL's loudness and particulate-matter
// sensors.
//
...
// table (the table — not the prose comment above it — is what the upstream code
// actually indexes, so it is authoritative). divisor is a single number for
// scalar types.
