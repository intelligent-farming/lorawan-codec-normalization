...
//
// Normalized payload codec for ellenex/tts2-l-v6 (TTS2-L-V6 - Temperature Transmitter).
//
...
function decodeUplink(input) {
  ...
  if (result && result.data) { result.data.make = "ellenex"; result.data.model = "tts2-l-v6"; }
  return result;
}
