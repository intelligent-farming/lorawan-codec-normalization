...
//
// Normalized payload codec for ellenex/drc3-l-v6 (DRC3-L-V6 - Radar Distance / Level Sensor (IP68)).
//
...
function decodeUplink(input) {
  ...
  if (result && result.data) { result.data.make = "ellenex"; result.data.model = "drc3-l-v6"; }
  return result;
}
