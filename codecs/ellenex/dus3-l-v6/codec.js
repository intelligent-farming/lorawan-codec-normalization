...
//
// Normalized payload codec for ellenex/dus3-l-v6 (DUS3-L-V6 - Ultrasonic Distance / Level Sensor (IP68)).
//
...
function decodeUplink(input) {
  ...
  if (result && result.data) { result.data.make = "ellenex"; result.data.model = "dus3-l-v6"; }
  return result;
}
