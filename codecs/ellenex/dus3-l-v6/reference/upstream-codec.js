...
//
// Ellenex DUS3-L (Version 6 firmware) sends a CBOR map on fPort 15 with
...
// so only documented key/unit facts are used). CBOR wire format matches
// ellenex/pls2-l-v6 (Apache-2.0 TTN reference). ttn null.
//
// SENSOR_MAP (key -> quantity, unit):
//   v -> battery (mV)
//   D -> tank.distance (m, distance to surface)
