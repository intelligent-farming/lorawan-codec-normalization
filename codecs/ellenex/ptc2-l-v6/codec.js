...
//
// Normalized payload codec for ellenex/ptc2-l-v6 (PTC2-L - Submersible Pressure Transmitter).
//
...
//
// Keys: v -> battery (mV); P -> pressure.gauge (bar -> kPa, x100)
...
function decodeUplink(input) {
  ...
  if (result && result.data) { result.data.make = "ellenex"; result.data.model = "ptc2-l-v6"; }
  return result;
}
