...
//
// Normalized payload codec for ellenex/duc3-l-v6 (DUC3-L-V6 - Ultrasonic Distance / Level Sensor (IP68)).
//
...
function decodeUplink(input) {
  ...
  if (result && result.data) { result.data.make = "ellenex"; result.data.model = "duc3-l-v6"; }
  return result;
}
