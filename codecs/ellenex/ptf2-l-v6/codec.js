...
//
// Normalized payload codec for ellenex/ptf2-l-v6 (PTF2-L - Flush Pressure Transmitter).
//
...
function decodeUplink(input) {
  ...
  if (result && result.data) { result.data.make = "ellenex"; result.data.model = "ptf2-l-v6"; }
  return result;
}
