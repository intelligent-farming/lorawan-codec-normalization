...
//
// Normalized payload codec for Elsys ERS (indoor multi-sensor: temperature,
// humidity, light, motion/PIR, CO2, etc.).
//
...
// with action.motion.detected = count > 0. Fields with no vocabulary key
// (acceleration, analog input, external temperature, sound, distance, etc.) are
