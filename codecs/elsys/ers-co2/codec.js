...
//
// Normalized payload codec for Elsys ERS CO2 (advanced indoor environment
// sensor: temperature, humidity, light, motion/PIR, CO2, etc.).
//
...
// with action.motion.detected = count > 0. CO2 (type 0x06) is ppm, mapped to
// air.co2 -- the upstream normalizeUplink drops CO2 entirely; we map it here.
// Fields with no vocabulary key (acceleration, analog input, external
// temperature, sound, distance, etc.) are emitted as camelCase extras.
